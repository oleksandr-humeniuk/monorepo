...
@Composable
fun WorkoutCompleteBottomSheet(
    onDone: () -> Unit,
) {
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            MonoText(
                text = stringResource(timerR.string.timer_run_congrats_title),
            ...
            MonoText(
                text = stringResource(timerR.string.timer_run_congrats_body),
            ...
            MonoPrimaryButton(
                text = stringResource(timerR.string.timer_run_congrats_cta),
                onClick = onDone,
                modifier = Modifier
                    .fillMaxWidth()
                    .height(52.dp),
